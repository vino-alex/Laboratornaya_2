...
new.df.countries <- rbind(new.df.countries, cbind(df[df$Reporter == usa, ], Countries = 'USA'))
new.df.countries <- rbind(new.df.countries, cbind(df[df$Reporter == eu, ], Countries = 'EU-28'))
new.df.countries <- rbind(new.df.countries, cbind(df[!(df$Reporter == usa) & !(df$Reporter == eu), ], Countries = 'Other countries'))
new.df.countries
